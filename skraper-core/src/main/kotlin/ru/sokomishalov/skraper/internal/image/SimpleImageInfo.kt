...
fun URL.getRemoteImageInfo(): SimpleImageInfo = openStream().getImageInfo()

private fun InputStream.getImageInfo(): SimpleImageInfo {
    val c1 = read()
    val c2 = read()
    var c3 = read()
    ...
    return SimpleImageInfo(width = width, height = height, mimeType = mimeType)
}
